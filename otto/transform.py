...
def normalize_data(config: Config, train_test: str, sample_size: int = None):
    ...
    OUTPUT:
    +--------+-------+-------------+----------+-----------------------+-----+
    |session |aid    |ts           |event_type|ds                     |event|
    +--------+-------+-------------+----------+-----------------------+-----+
    |12899779|59625  |1661724000278|clicks    |2022-08-28 22:00:00.278|1    |
    |12899780|1142000|1661724000378|clicks    |2022-08-28 22:00:00.378|1    |
    |12899780|582732 |1661724058352|clicks    |2022-08-28 22:00:58.352|1    |
    |12899780|973453 |1661724109199|clicks    |2022-08-28 22:01:49.199|1    |
    |12899780|736515 |1661724136868|clicks    |2022-08-28 22:02:16.868|1    |
    +--------+-------+-------------+----------+-----------------------+-----+
    """
    # I/O Paths
    if train_test == "train":
